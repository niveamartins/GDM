...
var UserMediaContext = React__default.createContext(null);
...
function UserMediaError(_a) {
    ...
    return React__default.createElement("p", null, errorMessage);
}
...
function useUserMedia(constraints) {
    ...
    var _a = React.useState(null), stream = _a[0], setStream = _a[1];
...
function UserMediaProvider(_a) {
    ...
    return (React__default.createElement(UserMediaContext.Provider, { value: mediaStream }, React__default.Children.only(children)));
}

var useUserMediaFromContext = function () { return React.useContext(UserMediaContext); };
...
function withUserMedia(WrappedComponent) {
    function Hoc(props) {
        ...
        return React__default.createElement(WrappedComponent, __assign({}, rest, { ref: forwardedRef, userMedia: userMedia }));
    }
...
exports.UserMediaContext = UserMediaContext;
exports.UserMediaError = UserMediaError;
exports.UserMediaProvider = UserMediaProvider;
exports.useUserMedia = useUserMedia;
exports.useUserMediaFromContext = useUserMediaFromContext;
exports.withUserMedia = withUserMedia;
